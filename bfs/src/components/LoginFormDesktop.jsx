      ...
      <div className='max-w-[37rem] relative pt-40'>
        ...
        <div className=' bg-white relative z-20 rounded-xl'>
          ...
          <div className='flex justify-center items-center '>
            ...
            <h3 className='min-w-36'>Log in or sign up</h3>
            <hr className='w-1/3 border-t border-gray-300' />
          </div>
          <form action='submit' method='post' className='flex flex-col'>
            ...
            <button
              type='submit'
              className='min-w-48 bg-green-800 mx-auto text-xl text-white rounded-xl py-2 mb-8'
            >
              Continue
            </button>
          </form>
          <div className=' text-center pb-10'>Need Help?</div>
        </div>
      </div>
    </div>
  );
